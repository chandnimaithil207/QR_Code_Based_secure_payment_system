...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface-900 border border-surface-600 rounded-xl p-4 lg:p-5 card-glow">
              ...
              <AreaChart data={data.trend}>
                <defs>
                  ...
                  <linearGradient id="gRed" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#ff4477" stopOpacity={0.35} />
                    <stop offset="100%" stopColor="#ff4477" stopOpacity={0} />
                  </linearGradient>
                </defs>
                ...
                <Tooltip
                  contentStyle={{ background: '#1e1e2a', border: '1px solid #3a3a4e', borderRadius: 8, fontSize: 12 }}
                  labelStyle={{ color: '#ccc' }}
                />
                <Area type="monotone" dataKey="verified" stroke="#00ff88" fill="url(#gGreen)" strokeWidth={2} />
                <Area type="monotone" dataKey="pending" stroke="#ffd700" fill="url(#gYellow)" strokeWidth={1.5} />
                <Area type="monotone" dataKey="fraud" stroke="#ff4477" fill="url(#gRed)" strokeWidth={1.5} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        ) : (
      ...
      <div className="bg-surface-900 border border-surface-600 rounded-xl overflow-hidden card-glow">
        <div className="flex items-center justify-between p-4 lg:p-5 border-b border-surface-600">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-surface-600">
                ...
                <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Transaction ID</th>
